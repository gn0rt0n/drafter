...
- FOUND: docs/README.md (79 lines, 18 tool links, 18 schema links)
- DELETED: docs/mcp-tools.md (correct)
- DELETED: docs/schema.md (correct)
- FOUND: 15-05-SUMMARY.md
- FOUND: a2cd45d — feat(15-05): overhaul docs/README.md as master documentation index
- FOUND: a1eabbd — feat(15-05): delete monoliths and update historical references
- FOUND: 4f3c5ac — docs(15-05): complete master index and monolith deletion plan
